...
# from unetr_pp.network_architecture.others_network.nnFormer.nnFormer_btcv import nnFormer
...
# from unetr_pp.network_architecture.others_network.unetr import UNETR
# from unetr_pp.network_architecture.others_network.swinunetr import SwinUNETR
...
from plt_3D_future import visualize_feature_map
...
class unetr_pp_trainer_btcv(Trainer_btcv):
    ...
    def initialize_network(self):
        ...
        # nnformer
        # self.network = nnFormer(num_classes=self.num_classes
        #                         )
